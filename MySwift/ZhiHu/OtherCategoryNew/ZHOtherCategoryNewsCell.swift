...
//
//  ZHOtherCategoryNewsCellTableViewCell.swift
//  MySwift
//
...
class ZHOtherCategoryNewsCell: UITableViewCell {

    //重用ID
    static fileprivate let identifier = "otherCateCell"
    ...
    class func cellWithTableView(_ tableView:UITableView) -> ZHOtherCategoryNewsCell{
        
        
        var cell = tableView.dequeueReusableCell(withIdentifier:identifier) as? ZHOtherCategoryNewsCell
        if cell == nil{
            
            cell = ZHOtherCategoryNewsCell(style: .default, reuseIdentifier: identifier)
        }
    ...
    var newModel:ZHOtherSingleNewModel?{
    ...
    private func updateSnpConstraintsWhenImageIsNil() {
